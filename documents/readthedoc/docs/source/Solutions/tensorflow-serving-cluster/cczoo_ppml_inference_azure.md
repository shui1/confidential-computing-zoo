...
3.2 Modify custom CoreDNS deployment file `tensorflowserving/kubernetes/coredns_custom.yaml` replacing `<secret provisioning service ip address>` with the public IP address of the Trusted System VM.
